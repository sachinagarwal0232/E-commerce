const Home = () => {
  return (
    <div className="scroll-smooth">
      ...
      {/* HERO SECTION */}
      <section id="home" className="h-[70vh] bg-indigo-600 text-white flex flex-col justify-center items-center text-center px-6">
      ...
      {/* ABOUT SECTION */}
      <section id="about" className="py-24 bg-gray-100 flex items-center px-6">
      ...
      {/* CONTACT SECTION */}
      <section id="contact" className="py-24 bg-white flex items-center px-6">
